...
export const instead = (caller: string, funcParent: any, funcName: string, callback: Function, oneTime: boolean) => patcher.instead(funcName, funcParent, wrapCallback("instead", callback), oneTime);
...
export const unpatchAll = () => stub("unpatchAll");
